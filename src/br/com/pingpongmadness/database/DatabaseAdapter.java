package br.com.pingpongmadness.database;
...
// #FEATURE: Persistência em banco de dados 
...
public class DatabaseAdapter {
    ...
    private static final String DATABASE_LEVELS_CREATE = "CREATE TABLE " + DATABASE_LEVELS_TABLE + 
    														...
    														LEVEL_SHOTS + " int not null, " + 
    														LEVEL_NAME + " text not null)";
    private static final String DATABASE_RECORDS_CREATE = "CREATE TABLE " + DATABASE_RECORDS_TABLE + 
    														" (" + RECORD_ID + " integer primary key autoincrement, " + 
    															   RECORD_LEVEL + " long not null, " + 
    															   RECORD_SCORE + " long not null, " + 
    															   RECORD_MISSES + " long not null)";
	
    // DATABASE QUERIES
    private static final String QUERY_STAR_MISSES = "SELECT " + RECORD_MISSES + 
    												" FROM " + DATABASE_RECORDS_TABLE + 
    												" WHERE " + LEVEL_TYPE + " = ?";
    ...
    public static Cursor fetchLevelsByType(Context context, int type) {
        ...
        return mDb.query(DATABASE_LEVELS_TABLE,
        				new String[] { LEVEL_ID, LEVEL_TYPE, LEVEL_SHOTS, LEVEL_NAME }, 
        				LEVEL_TYPE + "=" + type, 
        				null,
        				null,
        				null,
    ...
    public static ContentValues fetchRecord(Context context, String level_id) {
        ...
        Cursor cursor = mDb.query(true, DATABASE_RECORDS_TABLE,
        						  new String[] { RECORD_ID, RECORD_LEVEL, RECORD_SCORE, RECORD_MISSES },
        						  RECORD_LEVEL + "=" + level_id,
        						  null,
        						  null,
        						  null,
        						  RECORD_SCORE
